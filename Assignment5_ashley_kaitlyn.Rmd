---
title: "Exploring pacific giant salamanders abundance and weight in relationship to forest and channel type in Mack Creek, Oregon (2003 - 2017)"
...
#### Results D. Mean weights of Pacific giant salamanders by forest type (clear cut and old growth) in 2017. orrrr effects of forest type on salamander weight??
```{r}
...
#### Results E. Mean weights of pacific giant salamander by channel type (pool, cascade, side channel) in 2017. 
```{r}
#visual exploration
