...
When considering take of natural resource management, it is important to consider the effects resource take can have on its associated ecosystem. Studies have shown that clear cutting for logging operations can have both positive and negative impacts on the habitat and the species that live there (Murphy 1981).  The HJ Andrews Experimental Forest is a long term ecological research (lter) site that has two sections of forest, a clear cut section (ca. 1963) and a 500 year old coniferous forest, that allows researchers to investigate this question. Here we look at the Pacific giant salamander (*Dicamptodon tenebrosus*) (Figure 1.), an inhabitant of this area, and a species whose larval stage was shown to be negatively affected by logging (Corn 1989).  Using this lter survey data, we will investigate if there is any relationship to the type of forest Pacific giant salamanders reside in, to their abundance, weight and channel preference.
