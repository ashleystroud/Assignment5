...
#-------------------------------------------------------------------------------# 
```
Mean weights (g) differed significantly only between side channel and pool (one-way ANOVA with post-hoc Tukey's HSD, F(`r ps_aov_outputs[1]`, `r ps_aov_outputs[2]`) = `r round(ps_aov_outputs[7],2)`, *p* = `r round(ps_aov_outputs[9],3)`).
